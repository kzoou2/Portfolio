...
export default function HomeMain(){
    return(
        <section className="mainhome min-h-[85vh] w-[85%] mx-auto flex flex-col justify-center items-center md:items-center gap-2 md:gap-4 ">
            ...
            <h1 className="text-center text-4xl md:text-6xl font-bold tracking-wide leading-[1.3] md:leading-[1.25] text-balance dark:text-[#E4E4E4]">
                안녕하세요, <br/> 
                프론트엔드 개발자<br/> 
                <span className="font-extrabold text-[#9BE200] dark:text-[#8DFC7F]">이경주</span>입니다.
            </h1>

            <p className="text-[#9CA3AF] text-base md:text-xl text-center break-keep mb-5 md:mb-8 text-balance">
